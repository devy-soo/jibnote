...
function serialize(listing: Listing & { photos: Photo[] }) {
  return {
    ...
    totalUnits: listing.totalUnits ?? undefined,
    totalParkingSpots: listing.totalParkingSpots ?? undefined,
    ...
    loanAmount: listing.loanAmount ?? undefined,
...
const baseFields = z.object({
  ...
  totalParkingSpots: z.coerce.number().int().min(0).optional(),
  ...
  loanAmount: z.coerce.number().int().min(0).optional(),
